...
# Summarize the model
stability_BM_summary = summary(stability_BM)
stability_BM_anova = anova(stability_BM)
stability_BM_GLMM = r.squaredGLMM(stability_BM)

# Print the summaries
print(stability_BM_summary)
print(stability_BM_anova)
print(stability_BM_GLMM)
